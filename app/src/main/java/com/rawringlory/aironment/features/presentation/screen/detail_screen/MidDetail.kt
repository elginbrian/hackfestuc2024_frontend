...
fun MidScreen(){
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier.fillMaxSize()){
            Image(painter = painterResource(id = R.drawable.midscreen), contentDescription = "Healthy Screen",
        ...
        Column(modifier = Modifier
            ...
            Card(modifier = Modifier
                .width(120.dp)
                .height(24.dp),
                colors = CardDefaults.cardColors(Color(0xFFFEAC02))
            ) {
        ...
        Column(
            ...
            Row(modifier = Modifier.fillMaxWidth()) {
                Card(modifier = Modifier.size(72.dp),
                    colors = CardDefaults.cardColors(Color(0xFFFFEECC)),
                    border = BorderStroke(1.dp, Color(0xFFFEAC02))
                ) {
                    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                        Image(painter = painterResource(id = R.drawable.mask), contentDescription = "Mask")
                    }
                }
                ...
                Card(modifier = Modifier.size(72.dp),
                    ...
                    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                        Image(painter = painterResource(id = R.drawable.bus), contentDescription = "Bus")
                    }
                }
            }
                ...
                Box(modifier = Modifier
                    ...
                    Row() {
                        ...
                        Column(
                            ...
                            Text(text = "Terminal Joyoboyo", color = Color(0xFFFEAC02))
                ...
                Box(modifier = Modifier
                    ...
                    Row() {
                        ...
                        Column(
                            ...
                            Text(text = "Terminal Purabaya", color = Color(0xFFFEAC02))
                ...
                Box(modifier = Modifier
                    ...
                    Row() {
                        ...
                        Column(
                            ...
                            Text(text = "Terminal Bojonegoro", color = Color(0xFFFEAC02))
                            Text(text = "Jalan Joyoboyo 60242, Surabaya, Jawa Timur", fontSize = 12.sp)
                        }
                    }
                }
